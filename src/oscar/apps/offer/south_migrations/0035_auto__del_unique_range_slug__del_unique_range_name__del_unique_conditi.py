...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'offer_conditionaloffer', ['name'])

        # Removing unique constraint on 'ConditionalOffer', fields ['slug']
        db.delete_unique(u'offer_conditionaloffer', ['slug'])

        # Removing unique constraint on 'Range', fields ['name']
        db.delete_unique(u'offer_range', ['name'])

        # Removing unique constraint on 'Range', fields ['slug']
        db.delete_unique(u'offer_range', ['slug'])


    def backwards(self, orm):
        # Adding unique constraint on 'Range', fields ['slug']
        db.create_unique(u'offer_range', ['slug'])

        # Adding unique constraint on 'Range', fields ['name']
        db.create_unique(u'offer_range', ['name'])

        # Adding unique constraint on 'ConditionalOffer', fields ['slug']
        db.create_unique(u'offer_conditionaloffer', ['slug'])

        # Adding unique constraint on 'ConditionalOffer', fields ['name']
        db.create_unique(u'offer_conditionaloffer', ['name'])
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'upc': ('oscar.models.fields.NullCharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'})
        },
        ...
        'catalogue.productclass': {
            ...
            'slug': ('oscar.models.fields.autoslugfield.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '128', 'separator': "u'-'", 'blank': 'True', 'populate_from': "'name'", 'overwrite': 'False'}),

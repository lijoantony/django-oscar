...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ProductClass', fields ['slug']
        db.delete_unique(u'catalogue_productclass', ['slug'])

        # Removing unique constraint on 'Product', fields ['upc']
        db.delete_unique(u'catalogue_product', ['upc'])


    def backwards(self, orm):
        # Adding unique constraint on 'Product', fields ['upc']
        db.create_unique(u'catalogue_product', ['upc'])

        # Adding unique constraint on 'ProductClass', fields ['slug']
        db.create_unique(u'catalogue_productclass', ['slug'])
